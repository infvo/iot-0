...
Welkom bij *Het Internet of Things voor gebruikers* (IoT-1)!
...
De andere modules zijn: *Inleiding communicatie en netwerken* (IoT-0)
en *Het Internet of Things voor makers* (IoT-2).

De module IoT-0: *Inleiding communicatie en netwerken*, behandelt de basisbegrippen,
en is *bottom-up* georganiseerd, vanuit de *concepten*.
Waar de module IoT-1 georganiseerd is vanuit de *context* van het Internet of Things,
kan IoT-0 gebruikt worden voor de conceptuele verdieping - wanneer de behoefte daaraan ontstaat.

De module IoT-1 is *top-down* georganiseerd, vanuit de *context* van het Internet of Things.
...
De module IoT2: *het Internet of Things voor makers*, behandelt de details van deze IoT-knopen en IoT-ketens,
...
Een gesuggereerde manier van werken is dat leerlingen beginnen met het materiaal van IoT-1;
wanneer er vragen ontstaan over een bepaald begrip, bijvoorbeeld *snelheid van een verbinding*,
kan het materiaal van IoT-0 daarop antwoord geven.
Ook het materiaal van IoT-2 kan gebruikt worden als "just in time" naslagwerk bij Iot-1.
...
Zoals gezegd is de aanpak van IoT-1 *top-down*.
...
Het materiaal van de module IoT-1 is bedoeld voor een blok van 8-10 weken,
...
Na de behandeling van IoT-1 kunnen de leerlingen met een project IoT aan de slag.
Suggesties hiervoor worden later beschreven.

De tabel hieronder geeft een voorlopige planning.

.. csv-table:: Planning IoT-1

...
JSON voor IoT-knopen
====================

In de software bij deze module gebruiken we een vast JSON-formaat voor de verschillende soorten IoT-knopen.
Hierdoor kunnen we in de toepassingen de data van deze knopen op eenzelfde manier behandelen.
Dit JSON-formaat is een variant van het binaire Cayenne low power payload (LPP) formaat.
...
* het aantal bytes geeft aan welke waarden maximaal gerepresenteerd kunnen worden,
...
Het formaat van de downlink-berichten is wat eenvoudiger.
